...
function RightPane({ context }) {
    const [messageInput, setMessageInput] = useState('')
    const [msgLoading, setMsgLoading] = useState(false)
    const [messages, setMessages] = useState([
        {
            'type': 'aiMessage',
            'content': "Hi! I'm an AI assistant, here and ready to help you! You may ask me any question regarding the post!"
        },
    ])
    ...
    const handleSendContext = async () => {
        console.log('called handleContextSent')
    ...
    const renderMessages = () => {
        return messages.map((message, index) => (
            <div key={index} className={`${message.type} Message prose text-[#eee] `}>
                <img
    ...
    return (
        <div className='ml-10 h-screen flex flex-col ' style={{ maxWidth: '600px', margin: 'auto' }}>
            <h1 className='text-xl text-center py-4 bg-slate-950  rounded-xl'>Wizz Assistant</h1>
                ...
                <ScrollArea className='h-[600px] rounded-xl ' >
                    ...
                    {msgLoading && <div>
                        <div className={`aiMessage Message prose text-white`}>
                            <img
                    ...
                    <button
                        ...
                        className='mb-4 rounded-xl mt-2 w-full bg-secondary text-secondary-foreground hover:bg-secondary/90 inline-flex items-center justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 px-4 py-2'>
                        Get Insights on the Post
                    </button>
                </div>
